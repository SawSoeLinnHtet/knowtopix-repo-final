...
@section('content')
@include('site.blogs.layouts.header', ['title' => $blog->title, 'description' => $blog->description])
        ...
        <div class="card">
            <div class="row">
                ...
                <div class="col-md-7 p-0">
                    <div class="card-block py-3 px-2">
...
<section class="recent-posts">
    ...
    <div class="card-columns listrecent">
        @foreach ($posts as $post)
            <div class="card">
                <a href="post.html">
                    <img class="img-fluid" src="{{ asset('images/blogs/posts/'.$post->post_thumbnail) }}" alt="">
                </a>
                <div class="card-block px-2 py-3">
                    ...
                    <div class="metafooter">
                        <div class="wrapfooter">
                            ...
                            <span class="author-meta">
                                <span class="post-name"><a href="author.html"></a></span><br/>
