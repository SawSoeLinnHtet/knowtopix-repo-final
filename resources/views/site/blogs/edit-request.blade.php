            ...
            <div class="col-12 col-lg-12 col-xl-12 pb-5">
                <div class="create-blog-form-wrap">
                    ...
                    <div class="blog-form-wrap">
                        <form action="{{ route('site.blog.request.update', $blog->slug) }}" method="POST" id="blog-create" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="input-frame">
                                ...
                                <div class="blog-form-input-wrap mb-3">
                                    <div class="form-floating">
                                        <input type="text" class="form-control shadow-none" name="title" id="title" value="{{ $blog->title }}" placeholder="Enter your blog title">
                                ...
                                <div class="blog-form-input-wrap mb-3">
                                    <div class="form-floating">
                                        <input type="text" class="form-control shadow-none" name="author_name" value="{{ $blog->author_name }}" id="author_name" placeholder="Enter your name">
                                ...
                                <div class="blog-form-input-wrap mb-3">
                                    <div class="form-floating">
                                        <input type="email" class="form-control shadow-none" name="email" value="{{ $blog->email }}" id="email" placeholder="@example.com">
