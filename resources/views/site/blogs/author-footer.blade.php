                    ...
                    <div class="authorpostbox">
                        <div class="card shadow-lg">
                            <a href="{{  route('site.blog.post.details', [$blog->slug, $post->slug]) }}">
                                <img class="img-fluid img-thumb" src="{{ asset('images/blogs/posts/'.$post->post_thumbnail) }}" alt="">
                            </a>
                            <div class="card-block px-3 py-4">
                                <h2 class="card-title">
                                    <a href="{{ route('site.blog.post.details', [$blog->slug, $post->slug]) }}">{{ $post->title }}</a>
                                </h2>
                                <h4 class="card-text">
                                    {{ $post->description }}
                                </h4>
                                    ...
                                    <div class="wrapfooter">
                                        ...
                                        <span class="author-meta">
                                            <span class="post-name">
                                                <a href="{{ route('site.blog.author_details', $blog->slug) }}">{{ $blog->author_name }}</a>
                                            </span><br/>
